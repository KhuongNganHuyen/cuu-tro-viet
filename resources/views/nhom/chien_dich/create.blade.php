...
<form action="{{ url('/nhom/' . $nhom->idNhom . '/chien-dich') }}" method="POST">
  @csrf
    ...
    <div class="card-body">
      ...
      <div class="mb-0">
        ...
        <select name="trangThai" class="form-control">
          ...
          <option value="Tạm ngưng" {{ old('trangThai') == 'Tạm ngưng' ? 'selected' : '' }}>
            Tạm ngưng
          </option>
          <option value="Hoàn thành" {{ old('trangThai') == 'Hoàn thành' ? 'selected' : '' }}>
            Hoàn thành
          </option>
        </select>
      </div>
