...
@section('title', 'Thêm yêu cầu cứu trợ | Cứu Trợ Việt')
    ...
    <div class="row align-items-center">
      <div class="col-md-12">
        <div class="page-header-title">
          <h5 class="m-b-10">Thêm yêu cầu cứu trợ</h5>
        </div>
        <ul class="breadcrumb">
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <form action="{{ url('/admin/yeu-cau-cuu-tro') }}" method="POST">
      @csrf
        ...
        <div class="col-md-6 mb-3">
          ...
          <select name="idNguoiGui" class="form-control">
            ...
            @foreach ($nguoiDungs as $nguoiDung)
              <option value="{{ $nguoiDung->idNguoiDung }}" {{ old('idNguoiGui') == $nguoiDung->idNguoiDung ? 'selected' : '' }}>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="loaiYeuCau" class="form-control" value="{{ old('loaiYeuCau') }}"
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
          ...
          <input type="number" name="soHoDan" class="form-control" value="{{ old('soHoDan') }}">
        </div>
        ...
        <div class="col-md-4 mb-3">
          ...
          <select name="trangThai" class="form-control">
            <option value="Chờ tiếp nhận" {{ old('trangThai', 'Chờ tiếp nhận') == 'Chờ tiếp nhận' ? 'selected' : '' }}>Chờ tiếp nhận</option>
            <option value="Đã tiếp nhận" {{ old('trangThai') == 'Đã tiếp nhận' ? 'selected' : '' }}>Đã tiếp nhận</option>
            ...
            <option value="Từ chối" {{ old('trangThai') == 'Từ chối' ? 'selected' : '' }}>Từ chối</option>
          </select>
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="hinhAnh" class="form-control" value="{{ old('hinhAnh') }}" placeholder="Tạm thời để trống">
