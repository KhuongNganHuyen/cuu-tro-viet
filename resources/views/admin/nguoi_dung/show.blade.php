...
@php
  ...
  $laQuanTriVien = $nguoiDung->vaiTro === 'Quản trị viên';
@endphp
  ...
  <div class="card-header">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
      ...
      <div class="d-flex flex-wrap gap-2 justify-content-end">
        <a href="{{ url('/admin/nguoi-dung/' . $nguoiDung->idNguoiDung . '/edit') }}"
           class="btn btn-warning">
          Sửa thông tin
        </a>

        @if (!$laQuanTriVien)
          <form action="{{ url('/admin/nguoi-dung/' . $nguoiDung->idNguoiDung . '/doi-trang-thai') }}"
                method="POST"
          ...
          <form action="{{ url('/admin/nguoi-dung/' . $nguoiDung->idNguoiDung) }}"
                method="POST"
                onsubmit="return confirm('Bạn có chắc muốn xóa người dùng này không? Nếu người dùng đã có dữ liệu liên quan, hệ thống sẽ không cho phép xóa.')">
            @csrf
            @method('DELETE')
            ...
            <div class="row align-items-center justify-content-center">
              ...
              <div class="col-lg-7 col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 text-break">{{ $nguoiDung->hoTen }}</div>
                </div>

                <div class="row mb-3">
                  <div class="col-md-4 text-muted">Tên đăng nhập</div>
                  <div class="col-md-8 text-break">{{ $nguoiDung->tenDangNhap }}</div>
                </div>

                <div class="row mb-3">
                  <div class="col-md-4 text-muted">Email</div>
                  <div class="col-md-8 text-break">{{ $nguoiDung->email ?? '-' }}</div>
                </div>
