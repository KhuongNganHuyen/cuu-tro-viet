  ...
  <div class="card-body">
    ...
    <form action="{{ url('/admin/nhom-tinh-nguyen/' . $nhomTinhNguyen->idNhom) }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <textarea name="moTa" class="form-control" rows="3">{{ old('moTa', $nhomTinhNguyen->moTa) }}</textarea>
      </div>
      ...
      <div class="mb-3">
        ...
        <select name="trangThai" class="form-control">
          <option value="Đang hoạt động" {{ old('trangThai', $nhomTinhNguyen->trangThai) == 'Đang hoạt động' ? 'selected' : '' }}>Đang hoạt động</option>
          <option value="Tạm ngưng" {{ old('trangThai', $nhomTinhNguyen->trangThai) == 'Tạm ngưng' ? 'selected' : '' }}>Tạm ngưng</option>
          <option value="Chờ duyệt" {{ old('trangThai', $nhomTinhNguyen->trangThai) == 'Chờ duyệt' ? 'selected' : '' }}>Chờ duyệt</option>
        </select>
      </div>
